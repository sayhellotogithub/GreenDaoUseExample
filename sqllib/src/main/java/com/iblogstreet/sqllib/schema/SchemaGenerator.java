...
//
//import com.iblogstreet.sqllib.schema.SchemaVersion;
//
...
//    private static final String SCHEMA_OUTPUT_DIR = "../DogHome/src";
//
//    /**
...
//     *             if data is invalid
//     */
//    public static void validateSchemas(@Nonnull List<SchemaVersion> versions)
//            throws IllegalArgumentException {
//        int numCurrent = 0;
